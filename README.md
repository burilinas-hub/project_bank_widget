...
Проект "Виджет банковских операций клиента" - может принимать счета и номера карт и маскировать их.
...
- Функция **filter_by_currency** итератор, возвращающий транзакции с указанным кодом валюты.
    :param transactions: Список словарей с транзакциями
    :param currency_code: строка, код валюты, например 'USD'

- Функция **transaction_descriptions** генератор, возвращающий описание каждой транзакции.

- Функция **card_number_generator** генератор, выдающий номера карт в формате XXXX XXXX XXXX XXXX
...
```
git clone https://github.com/burilinas-hub/project_bank_widget.git
```
...
## Тестирование:
Проведен тест при помощи pytest
tests\test_generators.py ...                                                                    [100%]
